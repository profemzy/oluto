      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 sm:mt-20 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, i) => (
            <div
              key={i}
              className="relative rounded-xl border border-gray-200 bg-white p-6 hover:border-gray-300 hover:shadow-md transition-all duration-200"
            >
              <div className={`inline-flex rounded-lg p-2.5 ring-1 ring-inset ${feature.color}`}>
                {feature.icon}
              </div>
