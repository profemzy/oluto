...
export function CTASection({
  ...
  return (
    <section className="relative isolate overflow-hidden py-24 sm:py-32">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-50/80 via-white to-emerald-50/80 dark:from-cyan-950/50 dark:via-slate-900 dark:to-emerald-950/50" />
      
      {/* Floating decorative orbs */}
      <div className="absolute top-20 left-[10%] w-64 h-64 bg-cyan-200 dark:bg-cyan-800 rounded-full opacity-25 blur-3xl animate-float-slow" />
      <div className="absolute bottom-20 right-[10%] w-72 h-72 bg-green-200 dark:bg-green-800 rounded-full opacity-25 blur-3xl animate-float" />
      <div className="absolute top-1/2 left-[5%] w-40 h-40 bg-teal-200 dark:bg-teal-800 rounded-full opacity-20 blur-2xl animate-float-reverse" />
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              ...
              className="group inline-flex items-center gap-2 rounded-xl border-2 border-edge bg-surface/80 backdrop-blur-sm px-8 py-4 text-base font-bold text-body shadow-lg hover:bg-surface hover:border-cyan-300 hover:-translate-y-1 hover:shadow-xl transition-all duration-300"
            >
