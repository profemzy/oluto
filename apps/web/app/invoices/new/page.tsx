  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-surface-secondary relative">
      ...
      <PageHeader
        ...
        actions={
          <Link href="/invoices" className="group inline-flex items-center gap-2 rounded-xl border border-edge bg-surface px-4 py-2 text-sm font-bold text-body shadow-sm hover:bg-surface-hover transition-all">
        ...
        <div className="bg-surface/90 backdrop-blur-xl py-8 px-4 shadow-2xl shadow-gray-900/5 rounded-2xl border border-edge-subtle sm:px-10">
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <label htmlFor="invoiceNumber" className="block text-sm font-bold leading-6 text-heading">Invoice Number</label>
              ...
              <div>
                <label htmlFor="invoiceDate" className="block text-sm font-bold leading-6 text-heading">Invoice Date</label>
              ...
              <div>
                <label htmlFor="shipDate" className="block text-sm font-bold leading-6 text-heading">Ship Date <span className="text-caption font-normal">(optional)</span></label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <label htmlFor="billingAddress" className="block text-sm font-bold leading-6 text-heading">Billing Address <span className="text-caption font-normal">(optional)</span></label>
              ...
              <div>
                <label htmlFor="shippingAddress" className="block text-sm font-bold leading-6 text-heading">Shipping Address <span className="text-caption font-normal">(optional)</span></label>
            ...
            <div>
              <label htmlFor="customerMemo" className="block text-sm font-bold leading-6 text-heading">Customer Memo <span className="text-caption font-normal">(optional)</span></label>
            ...
            <div>
              ...
              <div className="border border-edge rounded-xl overflow-hidden">
                <div className="hidden lg:grid lg:grid-cols-12 gap-2 px-4 py-3 bg-gradient-to-r from-surface-secondary to-surface-tertiary border-b border-edge text-xs font-bold text-muted uppercase tracking-wider">
                ...
                <div className="divide-y divide-edge-subtle">
                  {lineItems.map((item, idx) => (
                    <div key={idx} className="grid grid-cols-1 lg:grid-cols-12 gap-2 px-4 py-3 items-center">
                      <div className="col-span-1 text-sm text-muted font-medium hidden lg:block">{idx + 1}</div>
                      ...
                      <div className="col-span-1 text-right">
                        <p className="text-sm font-bold text-heading">${item.amount}</p>
                      </div>
